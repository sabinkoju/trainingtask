        ...
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <div class="card card-box">
                    <div class="card-head">
                        <header><meta http-equiv="Content-Type" content="text/html; charset=utf-8">Event Details</header>
                            ...
                            {{ method_field('PUT') }}
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               placeholder="Enter Title" name="title" value="{{@$event->title}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control"
                                               placeholder="Enter Start Date" name="start_date" value="{{@$event->start_date}}">
                                    </div>
                                </div>
                                 ...
                                 <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control"
                                               placeholder="Enter End Date" name="end_date" value="{{@$event->end_date}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               placeholder="Enter Author Name" name="author" value="{{@$event->author}}">
                                    </div>
                                </div>
